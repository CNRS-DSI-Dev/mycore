...
OC.Lostpassword = {
    ...
    init : function() {
        if (!OC.appswebroots.password_policy) {
            OC.Lostpassword.resetErrorMsg = t('core', 'Password can not be changed. Please contact your administrator.');
        }
        else {
            OC.Lostpassword.resetErrorMsg = t('password_policy', 'Password can not be changed. Please enter a password that respects the password policy. If necessary, contact your administrator.');
        }

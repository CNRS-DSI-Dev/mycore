...
<form id="passwordform" class="section">
	...
	<p><?php p($l->t("Si vous ne connaissez pas votre mot de passe, voyez plus bas la section \"Informations utiles pour la connexion via utilisateur/mot de passe\".")); ?></p>

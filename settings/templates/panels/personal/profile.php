...
<form id="passwordform" class="section">
	...
	<p><?php print_unescaped($l->t("If you don't know your local My CoRe password, please see below, section <a href=\"?sectionid=additional#user_servervars2\">Useful Informations For Connection With Login / local My CoRe password</a>.")); ?></p>
</form>
<?php
}
?>
